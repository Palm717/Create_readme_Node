...
function init() {
  const questions = inquirer
    .prompt([
      ...
      },
      {
        type: "list",
        name: "license",
        choices: ["MIT", "Apache 2.0", "GPL v3", "BSD 3"],
      },
      {
        name: "collaborators",
        message:
          "Was this project application a collaboration? Provide detail.",
      },
      {
        name: "tests",
    ...
    .then((answerObj) => {
      ...
      fs.writeFile("README.md", generateMarkdown(answerObj), (err) => {
        if (err) {
  ...
  // markdown.renderLicenseBadge("mit");
}
